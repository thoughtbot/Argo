...
//  }
  static func create(int: Int)(string: String)(double: Double)(bool: Bool)(intOpt: Int?) -> TestModel {
    return TestModel(int: int, string: string, double: double, bool: bool, intOpt: intOpt)
  }
